...
return [
    ...
    */
    ...
    "phone"       => "Այս հեռախոսահամարը սխալ է: (Օր. +37477010203)",
    ...
    */
    ...
    'attributes' => [
        ...
        'available'             => 'Առկա',
        'size'                  => 'Չափ',
        'old_password'          => 'Հին գազտնաբառ',
        'nickname'              => 'Կեղծանուն',
        'marital_status'        => 'Ամուսնական կարգավիճակ',
        'birthday'              => 'Ծննդյան ամսաթիվ/օր/ամիս',
        'location'              => 'Գտնվելու վայր',
        'image'                 => 'Նկար',
        'check_police'          => 'Ոստիկանություն',
        'help_message'          => 'Ահազանգ SMS',
        'latitude'              => 'Լայնություն',
        'longitude'             => 'Երկարություն',
