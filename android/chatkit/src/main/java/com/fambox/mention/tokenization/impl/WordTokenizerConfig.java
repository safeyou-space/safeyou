...
package com.fambox.mention.tokenization.impl;
 ...
 * {@link com.fambox.mention.tokenization.impl.WordTokenizerConfig.Builder} class.
 */
public class WordTokenizerConfig {
    ...
    public static class Builder {
        ...
        @NonNull
        public com.fambox.mention.tokenization.impl.WordTokenizerConfig build() {
            return new com.fambox.mention.tokenization.impl.WordTokenizerConfig(lineSeparator, threshold, maxNumKeywords, explicitChars, wordBreakChars);
        }
    }
}
