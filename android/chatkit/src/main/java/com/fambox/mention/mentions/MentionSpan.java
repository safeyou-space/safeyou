...
public class MentionSpan extends ClickableSpan implements Parcelable {
    ...
    public static final Creator<com.fambox.mention.mentions.MentionSpan> CREATOR
            = new Creator<com.fambox.mention.mentions.MentionSpan>() {

        @NonNull
        public com.fambox.mention.mentions.MentionSpan createFromParcel(@NonNull Parcel in) {
            return new com.fambox.mention.mentions.MentionSpan(in);
        }

        @NonNull
        public com.fambox.mention.mentions.MentionSpan[] newArray(int size) {
            return new com.fambox.mention.mentions.MentionSpan[size];
        }
    };
}
