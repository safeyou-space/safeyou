...
public class MentionsEditable extends SpannableStringBuilder implements Parcelable {
     ...
     *
     * @return a new {@link com.fambox.mention.mentions.MentionsEditable} with whitespace characters removed from the beginning and the end
     */
    @NonNull
    public com.fambox.mention.mentions.MentionsEditable trim() {
        ...
        return new com.fambox.mention.mentions.MentionsEditable(this, 0, length());
    }
    ...
    public static final Creator<com.fambox.mention.mentions.MentionsEditable> CREATOR
            = new Creator<com.fambox.mention.mentions.MentionsEditable>() {
        public com.fambox.mention.mentions.MentionsEditable createFromParcel(Parcel in) {
            return new com.fambox.mention.mentions.MentionsEditable(in);
        }

        public com.fambox.mention.mentions.MentionsEditable[] newArray(int size) {
            return new com.fambox.mention.mentions.MentionsEditable[size];
        }
    };
}
