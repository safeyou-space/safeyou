...
import com.fambox.chatkit.commons.ImageLoader;
import com.fambox.chatkit.commons.ViewHolder;
import com.fambox.chatkit.commons.models.IMessage;
...
import com.fambox.chatkit.utils.RoundedImageView;
...
public class MessageHolders {
    ...
    public static final short MESSAGE_STATE_PENDING_TO_SEND = -1;
    public static final short MESSAGE_STATE_REACHED = 0;
    public static final short MESSAGE_STATE_DELIVERED = 1;
    public static final short MESSAGE_STATE_READED = 2;
    ...
    private static final short VIEW_TYPE_CALL_EVENT = 133;

    private Class<? extends ViewHolder<Date>> dateHeaderHolder;
    private int dateHeaderLayout;

    private HolderConfig<IMessage> callEventConfig;
    ...
    public MessageHolders() {
        ...
        this.callEventConfig = new HolderConfig<>(DefaultCallEventHolder.class, R.layout.item_call_event);
    ...
    protected ViewHolder getHolder(ViewGroup parent, int viewType, MessagesListStyle messagesListStyle) {
        switch (viewType) {
            case VIEW_TYPE_CALL_EVENT:
                return getHolder(parent, callEventConfig, messagesListStyle);
    ...
    protected int getViewType(Object item, String senderId) {
        ...
        if (item instanceof IMessage) {
            ...
            if (message.getCallEvent() > 0) {
                return VIEW_TYPE_CALL_EVENT;
            }
    ...
    public static class IncomingTextMessageViewHolder<MESSAGE extends IMessage>
        ...
        public void onBind(MESSAGE message) {
            ...
            if (text != null) {
                SpannableString ss = new SpannableString(message.getText().getText());
                for (ISpan span : message.getText().getSpans()) {
                    ClickableSpan clickableSpan = new ClickableSpan() {
                        @Override
                        public void onClick(View textView) {
                            try {
                                String text = message.getText().getText()
                                        .substring(span.getSpanStart(), span.getSpanEnd());
                                message.getClick().onMentionClick(text,
                                        span.getSpanStart(),
                                        span.getSpanEnd());
                    ...
                    try {
                        ss.setSpan(clickableSpan, span.getSpanStart(), span.getSpanEnd(), Spanned.SPAN_USER);
                        ss.setSpan(new RelativeSizeSpan(1.4f), span.getSpanStart(),
                                span.getSpanEnd(), Spanned.SPAN_USER);
                    } catch (Exception ignore) {
...
//            }
        ...
        public final void applyStyle(MessagesListStyle style) {
            ...
            if (bubble != null) {
                bubble.setPadding(style.getDimension(R.dimen.image_padding),
                        style.getDimension(R.dimen.image_padding),
                        style.getDimension(R.dimen.image_padding),
                        style.getDimension(R.dimen.image_padding));
                ViewCompat.setBackground(bubble, style.getIncomingImageOverlayDrawable());
            }
...
//            imageOverlay = itemView.findViewById(R.id.imageOverlay);
            ...
            if (image instanceof RoundedImageView) {
                ((RoundedImageView) image).setCorners(
                        R.dimen.image_bubble_corners_radius,
                        R.dimen.image_bubble_corners_radius,
                        R.dimen.image_bubble_corners_radius,
                        R.dimen.image_bubble_corners_radius
                );
        ...
        public final void applyStyle(MessagesListStyle style) {
            ...
            if (bubble != null) {
                bubble.setPadding(style.getDimension(R.dimen.image_padding),
                        ...
                        style.getDimension(R.dimen.image_padding),
                        style.getDimension(R.dimen.image_padding));
                ViewCompat.setBackground(bubble, style.getOutcomingImageOverlayDrawable());
            }
...
//            imageOverlay = itemView.findViewById(R.id.imageOverlay);
    ...
    /**
     * Default view holder implementation for call event
     */
    public static class DefaultCallEventViewHolder<MESSAGE extends IMessage>
            extends BaseMessageViewHolder<MESSAGE>
            implements DefaultMessageViewHolder {

        protected TextView text;

        public DefaultCallEventViewHolder(View itemView, Object payload) {
            super(itemView, payload);
            text = itemView.findViewById(R.id.messageText);
        }
        ...
        public void onBind(MESSAGE message) {
            if (text != null) {
                text.setText(message.getText().getText());
            }
        }
...
//                        style.getDateHeaderPadding(), style.getDateHeaderPadding());
    ...
    public abstract static class BaseOutcomingMessageViewHolder<MESSAGE extends IMessage>
        ...
        protected TextView time;
        protected ImageView messageState;
        ...
        public void onBind(MESSAGE message) {
            ...
            if (messageState != null) {
                switch (message.getMessageState()) {
                    case MESSAGE_STATE_PENDING_TO_SEND:
                        messageState.setImageResource(R.drawable.icon_message_sending);
                        break;
                    case MESSAGE_STATE_REACHED:
                        messageState.setImageResource(R.drawable.icon_message_has_reached);
                        break;
                    case MESSAGE_STATE_DELIVERED:
                        messageState.setImageResource(R.drawable.icon_message_delivered);
                        break;
                    case MESSAGE_STATE_READED:
                        messageState.setImageResource(R.drawable.icon_messge_readed);
                        break;
                }
            }
        }
    ...
    private static class DefaultCallEventHolder extends DefaultCallEventViewHolder<IMessage> {

        public DefaultCallEventHolder(View itemView) {
            super(itemView, null);
        }
    }
