...
import com.fambox.chatkit.commons.Style;
...
class MessageInputStyle extends Style {
    ...
    private int recordAudioButtonIcon;
    private String recordAudioButtonContentDescription;
    private String takePhotoButtonContentDescription;
    private String inputButtonContentDescription;
    private String attachmentButtonContentDescription;
    private int takePhotoButtonIcon;
    ...
    static MessageInputStyle parse(Context context, AttributeSet attrs) {
        ...
        style.recordAudioButtonIcon = typedArray.getResourceId(R.styleable.MessageInput_recordAudioButtonIcon, -1);
        style.recordAudioButtonContentDescription = typedArray.getString(R.styleable.MessageInput_recordAudioButtonContentDescription);
        style.takePhotoButtonContentDescription = typedArray.getString(R.styleable.MessageInput_takePhotoButtonContentDescription);
        style.inputButtonContentDescription = typedArray.getString(R.styleable.MessageInput_inputButtonContentDescription);
        style.attachmentButtonContentDescription = typedArray.getString(R.styleable.MessageInput_attachmentButtonContentDescription);
        style.takePhotoButtonIcon = typedArray.getResourceId(R.styleable.MessageInput_takePhotoButtonIcon, -1);
    ...
    protected Drawable getTakePhotoButtonIcon() {
        if (takePhotoButtonIcon == -1) {
            ...
            return getDrawable(takePhotoButtonIcon);
        }
    }

    protected Drawable getRecordAudioButtonIcon() {
        if (recordAudioButtonIcon == -1) {
            return getSelector(attachmentButtonDefaultIconColor, attachmentButtonDefaultIconPressedColor,
                    attachmentButtonDefaultIconDisabledColor, R.drawable.ic_add_attachment);
        } else {
            return getDrawable(recordAudioButtonIcon);
        }
    }

    protected String getRecordAudioButtonContentDescription() {
        return recordAudioButtonContentDescription;
    }

    protected String getTakePhotoButtonContentDescription() {
        return takePhotoButtonContentDescription;
    }

    protected String getInputButtonContentDescription() {
        return inputButtonContentDescription;
    }

    protected String getAttachmentButtonContentDescription() {
        return attachmentButtonContentDescription;
    }
