...
- (instancetype)initWithCoder:(NSCoder *)coder
{
    ...
    if (self) {
        ...
        if (self.checkedImage) {
            ...
            self.checkedImage = [[UIImage imageNamed:@"icon_checkbox_checked"] imageWithTintColor: UIColor.purpleColor1];
        }
        ...
        if (self.unCheckedImage) {
            ...
            self.unCheckedImage = [[UIImage imageNamed:@"icon_checkbox_unchecked"] imageWithTintColor: UIColor.purpleColor1];
        }
    }
    return self;
}
