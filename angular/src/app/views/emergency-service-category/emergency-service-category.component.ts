...
@Component({
  selector: 'app-emergency-service-category',
  templateUrl: './emergency-service-category.component.html',
  styleUrls: ['./emergency-service-category.component.scss']
})
export class EmergencyServiceCategoryComponent implements OnInit {
  ...
  ngOnInit() {
    this.url = `${environment.endpoint}${this.requestService.activeCountryCode}${environment.emergencyServiceCategory.get}`;
    this.getData(`${this.url}`);
  }

  // get all emergency categories table data
  getData(url) {
