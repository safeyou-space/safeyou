...
export class HelpMessageComponent implements OnInit {
  ...
  ngOnInit() {
    this.url = `${environment.endpoint}${this.requestService.activeCountryCode}${environment.helpMessages.get}`;
    this.getData(`${this.url}`);
  }

  // get all help-message table data
  getData(url) {
  ...
  // get all language list function
